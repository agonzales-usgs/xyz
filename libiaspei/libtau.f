...
c   Append two blanks and print the string.
 7    i=i+2
      ib(i-1:i-1)=' '
      ib(i:i)=' '
c   tnoua2 prints the first i characters of ib without a newline.
 4    call tnoua22(ib,i)
      if(ifl.gt.0) return
...
c $$$
c  The following routines, warn, tnoua2, and dasign, were is a separate file named libsun.a
...
c
 ...
 100  format(1x,a)
      ...
      subroutine tnoua22(ia,n)
c
c $$$$$ calls no other routine $$$$$
c
c   Subroutine tnoua22 writes the first n characters of string ia to the
